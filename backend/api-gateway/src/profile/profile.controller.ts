...
export class ProfileController {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get profile query params.' })
  getProfileBy(@Req() req: Request): Promise<any> {
    console.log(
      'API Gateway - Profile Controller - getProfileByUserId at',
      new Date(),
    );

    return this.profileService.getProfileBy(req.query);
  }
